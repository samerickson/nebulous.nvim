...
function setup.load_colors(scheme, settings)
  ...
  local editor = {
    ...
    Constant =         { fg = scheme.Purple,     bg = scheme.none,       scheme.none },
    ...
    markdownH2 =                { fg = scheme.Orange,     bg = scheme.none, scheme.none },
    markdownH3 =                { fg = scheme.DarkOrange, bg = scheme.none, scheme.none },
    ...
    ["@tag"] =                 { fg = scheme.Pink,       bg = scheme.none, scheme.none },
    ["@tag.attribute"] =       { fg = scheme.Blue,       bg = scheme.none, scheme.none },
    ["@tag.delimiter"] =       { fg = scheme.Yellow,     bg = scheme.none, scheme.none },
    ["@namespace"] =           { fg = scheme.Purple,     bg = scheme.none, scheme.none },
    -- ["@macro"] = {},
    -- ["@text.underline"] = {},
    -- ["@todo"] = {},
    -- ["@type.definition"] = {},
